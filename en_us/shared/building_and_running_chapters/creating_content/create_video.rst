...
This section also describes the process of :ref:`adding a bumper video<Adding
a Bumper Video>` to your course.
...
files, including YouTube videos and videos that are hosted in other
...
automatically scrolls as the video plays. A student can select a word in the
...
option. Students can then select either **SubRip (.srt) file** or **Text
(.txt) file** to download the .srt or .txt transcript.
...
`Amazon S3 <http://aws.amazon.com/s3/>`_. When a student views a video in your
course, if the YouTube video does not play, the copy on the backup site starts
playing automatically. You can also allow the student to download the video
...
site where you post the videos may need to handle high traffic volume.
...
To add the video and its transcript to your course, follow these steps.
...
.. note:: To be sure that all students can access a video, you can 
...
5. Next to **Default Timed Transcript**, select an option. 
   ...
   * If neither edX nor YouTube has a transcript for your video, and your
     transcript uses the .srt format, select **Upload New Transcript** to upload
...
.. list-table::
    ...
    * - **Upload Handout**
      - Allows you to upload a handout to accompany this video. Your handout
        can be in any format. Students can download the handout by selecting
...
contains links to different parts of the video. When your students view the
video, they can select **CC** to switch between the main transcript for the
video and the table of contents.

To add a table of contents, you work with a third-party service to create the
...
Transcript** in the video player, and students can download the .srt, .txt, or
...
.. include:: ../../../shared/building_and_running_chapters/creating_content/create_video_bumper.rst
